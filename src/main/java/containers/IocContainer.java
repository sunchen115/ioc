...
public class IocContainer {
    ...
    public Object getBeanById(String id) {
        if (mapIdToObj.containsKey(id)) {
            return mapIdToObj.get(id);
        }
    ...
    private Object getBeanBySetter(ClassInfo clsInfo) {
        try {
            ...
            for (int i = 0; i < props.size(); i++) {
                ...
                Attribute attrType = prop.getAttribute("type");
                ...
                Method setFunc = objClass.getMethod(setMethodName, paramTypes);
                setFunc.invoke(obj, params);
            }
            return obj;
